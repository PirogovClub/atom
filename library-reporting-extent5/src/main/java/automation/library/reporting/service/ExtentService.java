...
public class ExtentService
    ...
    public static class ExtentReportsLoader {
        ...
        private static final String OUTPUT_PATH = "RunReports/";
        ...
        private static String getOutputPath(Properties properties, String key) {
            ...
            out = out == null || out.equals("null") || out.isEmpty() ? OUTPUT_PATH + key.split("\\.")[2] +Reporter.getReportName()+ "/" : out;
