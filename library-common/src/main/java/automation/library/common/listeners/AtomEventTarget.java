...
/**
 * Copy from w3 classes
 * Not in full use right now
 ...
 */
public interface AtomEventTarget<T> {

    /**
     * the only method used so far return object that generate the event for usage
     * in the event consumer
     * @return Object that generate the Event
     */
    public T getObjectToStore() ;

    /**
     *
     * Implement trough Event Manager for now
     *
     ...
     *
     * @param event       The event event for which the user is registering
     ...
     *                   events of the specified event will be dispatched to the registered
     ...
     *
     * @param event       Specifies the event event of the <code>EventListener</code>
     *                   being removed.
     ...
     * @throws AtomEventExeption UNSPECIFIED_EVENT_TYPE_ERR: Raised if the <code>Event</code>'s type
     *                        was not specified by initializing the event before
     *                        <code>dispatchEvent</code> was called. Specification of the
     *                        <code>Event</code>'s type as <code>null</code> or an empty string
     *                        will also trigger this exception.
     */
    public boolean dispatchEvent(String evt)
            throws AtomEventExeption;
